...
# healthy_count_train = sum(1 for _, target in train_dataset.samples if target == 0)
# diseased_count_train = len(train_dataset) - healthy_count_train
# healthy_count_val = sum(1 for _, target in val_dataset.samples if target == 0)
# diseased_count_val = len(val_dataset) - healthy_count_val



# # Calculate class sizes
# # healthy_count = sum(1 for _, target in full_dataset.samples if target == 0)
# # diseased_count = len(full_dataset) - healthy_count


# print(f"Plant: {args.plant}")
# print(f"Model: {args.model}")
# print(f"Total training dataset size: {len(train_dataset)}")
# print(f"Training healthy class: {plant_categories[plant]['healthy']}, Size: {healthy_count_train}")
# print(f"Training diseased classes: {plant_categories[plant]['diseased']}, Size: {diseased_count_train}")
# print(f"Total validation dataset size: {len(val_dataset)}")
# print(f"Validation healthy class: {plant_categories[plant]['healthy']}, Size: {healthy_count_val}")
# print(f"Validation diseased classes: {plant_categories[plant]['diseased']}, Size: {diseased_count_val}")
