...
# Directories
print("Background")
print("Train on Tomato  test on PlantVill")




# Directories
train_dir   = "/cs/home/psxjs24/data/tomato_binary/data/background"
val_dir =    "/cs/home/psxjs24/data/PlantVillage/planttomato/background"
...
train_dataset = CustomDataset(root_dir=train_dir, transform=data_transforms['train'])
val_dataset = CustomDataset(root_dir=val_dir, transform=data_transforms['val'])
